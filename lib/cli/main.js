...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `sbercoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ sbercoincore-node add wallet-service');
      console.log('    $ sbercoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ sbercoincore-node remove wallet-service');
      console.log('    $ sbercoincore-node remove insight-api');
      console.log();
    });
